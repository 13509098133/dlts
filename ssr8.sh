...
#wget -N –no-check-certificate https://raw.githubusercontent.com/13509098133/dlts/master/ssr8.sh
...
Set_config_password(){
	...
	read -e $1 -p "(默认: doub.io):" ssr_password
